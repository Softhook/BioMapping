...
* Pin 16 (PC1) — **no longer connected to GPS** → used for I2C **SCL**
* Pin 15 (PC0) — **no longer connected to GPS** → used for I2C **SDA**
...
* **Power & I2C (ADS1115):**
  ...
  * `SCL` on ADS1115 -> **Pin 16 (PC1)**
  * `SDA` on ADS1115 -> **Pin 15 (PC0)**
