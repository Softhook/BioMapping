...
export const GSRGlobe3DBuildings = {
  ...
  fillColor(style) {
    switch (style) {
      case 'dark':
        return Cesium.Color.fromCssColorString('#242833');
      case 'monochrome':
        return Cesium.Color.fromCssColorString('#e4e7ee');
      case 'glass':
        return Cesium.Color.fromCssColorString('#00d4ff').withAlpha(0.35);
      default:
        return Cesium.Color.fromCssColorString('#ded7cb'); // realistic wall base
    }
  },
  ...
  outlineColorFor(style) {
    switch (style) {
      case 'dark':
        return Cesium.Color.fromCssColorString('#101216').withAlpha(0.8);
      case 'monochrome':
        return Cesium.Color.fromCssColorString('#9ba1ac').withAlpha(0.6);
      case 'glass':
        return Cesium.Color.fromCssColorString('#00ffff').withAlpha(0.7);
      default:
        return Cesium.Color.fromCssColorString('#262320').withAlpha(0.75); // realistic dark edge
    }
  },
  ...
  tileStyleExpression(style) {
    switch (style) {
      case 'dark':
        return "color('#1c202a', 1.0)";
      case 'monochrome':
        return "color('#f0f2f6', 1.0)";
      case 'glass':
  ...
  buildPrimitive(osmJson, style = 'glass') {
    if (typeof Cesium === 'undefined' || !osmJson || !osmJson.elements)
      return null;
    ...
    if (
      ...
      typeof Cesium.PrimitiveCollection === 'function'
    ) {
