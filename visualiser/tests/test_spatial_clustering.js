...
// ─── compactClusters ─────────────────────────────────────────────────────
// (clusterPeaks() — the old single-linkage N×N-matrix clusterer — was removed
// 2026-09-08: it had no src/ callers, compactClusters() is the sole clusterer
// the Arousal Places layer uses.)
