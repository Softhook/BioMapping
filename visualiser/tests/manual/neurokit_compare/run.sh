...
if [ ${#TRACK_NAMES[@]} -eq 0 ]; then
  TRACK_NAMES=(biomap_live_2026-09-10T17-20-02-105Z biomap_028)
elif [ "${1:-}" = "all" ]; then
  TRACK_NAMES=(biomap_live_2026-09-10T17-20-02-105Z biomap_028 biomap_019 biomap_027 biomap_053 biomap_059)
fi
