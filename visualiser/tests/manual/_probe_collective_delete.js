...
console.log(
  ...
  map._groups.size,
  '| manager tracks:',
  window.AppState.collectiveManager.tracks.length,
);
...
console.log(
  'direct render kinds (bypassing groups):',
  JSON.stringify(map.directRenderKinds()),
);
console.log(
  '_renderedTrackGroups size:',
  window.AppState.mapManager._renderedTrackGroups.size,
);
console.log(
  '_unownedLayers length:',
  window.AppState.mapManager._unownedLayers.length,
);
...
console.log(
  'after render (toggles off): on-map=',
  JSON.stringify(countMapLayers()),
  'groups=',
  map._groups.size,
);
console.log(
  '  _unownedLayers:',
  mm._unownedLayers.length,
  '| direct kinds:',
  JSON.stringify(map.directRenderKinds()),
);
