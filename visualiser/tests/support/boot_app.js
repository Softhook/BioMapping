...
const SCRIPT_ORDER = [
  ...
  'src/signal/csv_parser.js', 'src/signal/spectral_eda.js', 'src/signal/analyzer_time_format.js', 'src/signal/analyzer.js', 'src/osm/osm_enrichment.js', 'src/osm/ndvi_sampler.js', 'src/gps/map_match.js', 'src/signal/gsr_filter.js', 'src/render/marching_squares.js',
  'src/map/hillshade.js', 'src/spatial/spatial_clustering.js', 'src/spatial/arousal_places.js', 'src/spatial/collective_manager.js', 'src/gps/gps_filter.js', 'src/map/map_colors.js', 'src/gps/gps_pipeline.js', 'src/map/map_markers.js',
  'src/live/live_binary_parser.js', 'src/live/live_state.js', 'src/live/live_bluetooth.js', 'src/live/live_csv.js', 'src/live/live_tile_cache.js', 'src/live/live_view.js',
