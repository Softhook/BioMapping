 ...
 *
 * live.html's script is a single inline block, not separate <script src>
 * files, so unlike boot_app.js there's no SCRIPT_ORDER — it's extracted
 * from the HTML and run once. Its top-level `const`/`class`/`function`
