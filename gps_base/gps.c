...
int32_t gps_app(void* p) {
    ...
    // === CRITICAL: Enable OTG 5V power for the GPS module ===
    // The L76K GNSS Shield (and most GPS modules) need 5V from the Flipper's
    // OTG power line. Without this, the GPS never powers on and you'll see
    // "Waiting for fix..." forever.
