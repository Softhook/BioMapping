...
`docs/eda_detection_benchmark.md`'s Next Plan (item 17).
...
`eda_detection_benchmark.md` (51.4% recall on the clean 3-way benchmark) — that number reflects
...
scenarios; see `eda_detection_benchmark.md` Next Plan item 17 for the follow-up.
