...
// Test 2: Direct download fallback execution in non-browser env (Node.js) for plain text / CSV
(async () => {
  ...
  console.log("  ✓ GSRFileSaver handles string CSV content");

  // Test 3: Data URL conversion
  const dataUrl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==";
  const dataUrlResult = await GSRFileSaver.saveFile(dataUrl, "test_chart.png");
  assert(dataUrlResult === true, 'saveFile handles data URLs');
  console.log("  ✓ GSRFileSaver parses data URL to Blob");
